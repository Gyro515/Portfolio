  ...
  return (
    <main className="flex flex-col justify-start items-center text-center pb-20 mx-auto w-full max-w-screen-xl">
      ...
      <section
        ...
        className="flex flex-col items-center justify-center min-h-[clamp(540px,91.75svh,900px)] w-[90%] md:w-[50%] gap-4"
      >
        <motion.h1
          id="home-heading"
      ...
      <section
        ...
        className="flex flex-col items-center justify-start scroll-mt-[clamp(30px,2.5svh,96px)] min-h-[clamp(540px,80svh,900px)] w-full md:w-[60%] gap-8 md:gap-10"
      >
        <h2
          id="projects-heading"
        ...
        <div className="w-[80%] rounded-xl border border-gray-200 bg-gray-200 p-4 shadow-sm">
          <div
            className="h-[22rem] md:h-[25rem] overflow-y-auto pr-1"
            role="region"
      ...
      <section
        ...
        className="flex flex-col items-center justify-start scroll-mt-[clamp(30px,2.5svh,96px)] min-h-[clamp(540px,80svh,900px)] w-[90%] md:w-[60%] gap-10"
      >
        ...
        <div className="md:pt-1 flex flex-col text-left justify-center w-[90%] md:w-[80%]">
          ...
          <TechStackComponent
            ...
            tech={[
              ...
              { name: 'Microsoft Azure', icon: 'devicon:azure' },
            ]}
          />
          <TechStackComponent
      ...
      <section
        ...
        className="flex flex-col items-center justify-start scroll-mt-[clamp(30px,20svh,96px)] md:scroll-mt-[clamp(30px,2.5svh,96px)] min-h-[clamp(540px,80svh,900px)] w-[90%] md:w-[60%] gap-8 md:gap-10"
      >
            ...
            <div className="pt-1 flex flex-col gap-5 md:pl-10 md:border-l-2 md:border-gray-900">
              <TimelineComponent
                ...
                bullets={[
                  ...
                  'Senior System Development Project',
                  'Advanced Database',
                  'Conceptual Modeling',
...
function ProjectCardComponent({
  ...
  return (
    <Link
      ...
      className="group block relative overflow-hidden w-full h-[20rem] md:h-[23rem] rounded-xl bg-gray-50 hover:shadow-xl transition focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-800"
    >
      {/* Image */}
